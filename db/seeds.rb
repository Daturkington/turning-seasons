...
asparagus_recipe = Recipe.create(name:"Asparagus with fried egg and salsa macha", author:"Thomasina Miers", servings: 2, cooking_time: 25, description: "Salsa macha is a Mexican sauce I am in love with. Garlic is poached gently in oil, followed by peanuts, dried red chillies and sesame seeds. The resulting (highly addictive) oil is drizzled over the hundreds of different seafood tostadas; a dish found up and down the coastline of Baja California.
...
Quantity.create(measurement: 300, ingredient: asparagus, recipe: asparagus_recipe, unit: "g")
Quantity.create(measurement: 4, ingredient: eggs, recipe: asparagus_recipe)
Quantity.create(measurement: 60, ingredient: butter, recipe: asparagus_recipe, unit: "g")
Quantity.create(measurement: 1, ingredient: parsley, recipe: asparagus_recipe, unit: "handful")
Quantity.create(measurement: 5, ingredient: garlic, recipe: asparagus_recipe , unit: "cloves")
Quantity.create(measurement: 60, ingredient: hazelnuts, recipe: asparagus_recipe, unit: "g")
Quantity.create(measurement: 40, ingredient: sesame, recipe: asparagus_recipe, unit: "g")
Quantity.create(measurement: 10, ingredient: dried_chillies, recipe: asparagus_recipe, unit: "g")
Quantity.create(measurement: 1, ingredient: sugar, recipe: asparagus_recipe, unit: "tsp")
Quantity.create(measurement: 3, ingredient: anchovies, recipe: asparagus_recipe)
Quantity.create(measurement: 300, ingredient: oil, recipe: asparagus_recipe, unit: "ml")
Quantity.create(measurement: 1, ingredient: salt, recipe: asparagus_recipe, unit: "tsp")
...
aubergine_recipe = Recipe.create(name:"Aubergine wedges with lime and pistachio crumb", author:"Anna Jones", servings: 4, cooking_time: 30, description: "Aubergine doesn’t get much attention in my kitchen; my husband, John, doesn’t like it (though I think this is because he has eaten so many badly cooked aubergines – not by me, of course). But a couple of weeks ago, I found myself pining for aubergine like it was a long-lost friend. I cooked up some fat wedges until they were dark and golden on the outside, topped them with a lime and pistachio crumb, and ate a happy solo lunch with flatbreads and salted yoghurt. I also tried it paired with tamarind in this sweet-and-sour curry, spooned on to sticky jasmine rice. My aubergine craving was quelled and, of course, John licked his plate clean.", instructions: "Cut the aubergines lengthways into six to eight wedges (see picture), depending on their size. In a large, nonstick frying pan, heat the oil and fry the aubergines in batches, turning carefully. Once each batch is golden all over, set aside on a roasting tray and keep warm in the oven while you fry the rest.
...
Quantity.create(measurement: 3, ingredient: oil, recipe: aubergine_recipe, unit: "tbsp")
Quantity.create(measurement: 100, ingredient: pistachios, recipe: aubergine_recipe, unit: "g")
Quantity.create(measurement: 2, ingredient: limes, recipe: aubergine_recipe)
Quantity.create(ingredient: salt, recipe: aubergine_recipe)
Quantity.create(measurement: 250, ingredient: greek_yoghurt, recipe: aubergine_recipe, unit: "ml")
Quantity.create(measurement: 1, ingredient: sumac, recipe: aubergine_recipe, unit: "pinch")
...
Quantity.create(measurement: 5, ingredient: ginger, recipe: aubergine_recipe2, unit: "cm")
Quantity.create(measurement: 3, ingredient: garlic, recipe: aubergine_recipe2, unit: "cloves")
Quantity.create(measurement: 1, ingredient: lemongrass, recipe: aubergine_recipe2, unit: "stalk")
...
Quantity.create(measurement: 1, ingredient: ground_coriander, recipe: aubergine_recipe2, unit: "tsp")
Quantity.create(measurement: 300, ingredient: vine_tomatoes, recipe: aubergine_recipe2, unit: "g")
Quantity.create(measurement: 2, ingredient: tamarind_paste, recipe: aubergine_recipe2, unit: "tbsp")
Quantity.create(measurement: 400, ingredient: coconut_milk, recipe: aubergine_recipe2, unit: "ml")
Quantity.create(measurement: 200, ingredient: vegetable_stock, recipe: aubergine_recipe2, unit: "ml")
...
beetroot_recipe = Recipe.create(name:"Whole baked beetroot, roasted beet leaves, whipped feta, crisp olives", servings: 4, cooking_time: 85, author:"Anna Jones", description: "This is as suited to the oven as it is to the barbecue. The simple foil-covered method for roasting works every time", instructions: "Heat the oven to 180C/160C fan/390F/gas 4. If the beetroots still have their leafy tops, cut them off close to the top of the beet, leaving yourself enough to grip.
...
Quantity.create(measurement: 500, ingredient: beetroot, recipe: beetroot_recipe, unit: "g")
Quantity.create(measurement: 50, ingredient: black_olives, recipe: beetroot_recipe, unit: "g")
Quantity.create(measurement: 2, ingredient: sesame, recipe: beetroot_recipe, unit: "tbsp")
Quantity.create(measurement: 1, ingredient: cumin_seeds, recipe: beetroot_recipe, unit: "tsp")
Quantity.create(measurement: 1, ingredient: nigella_seeds, recipe: beetroot_recipe, unit: "tsp")
Quantity.create(measurement: 2, ingredient: oil, recipe: beetroot_recipe, unit: "tbsp")
Quantity.create(measurement: 2, ingredient: red_wine_vinegar, recipe: beetroot_recipe, unit: "tbsp")
Quantity.create(measurement: 1, ingredient: orange, recipe: beetroot_recipe)
Quantity.create(measurement: 100, ingredient: feta, recipe: beetroot_recipe, unit: "g")
Quantity.create(measurement: 50, ingredient: greek_yoghurt, recipe: beetroot_recipe, unit: "tbsp")
...
Quantity.create(measurement: 300, ingredient: broad_beans, recipe: broadbean_recipe, unit: "g")
Quantity.create(measurement: 150, ingredient: carrots, recipe: broadbean_recipe, unit: "g")
Quantity.create(measurement: 75, ingredient: coppa, recipe: broadbean_recipe, unit: "g")
Quantity.create(measurement: 1, ingredient: garlic, recipe: broadbean_recipe, unit: "clove")
Quantity.create(measurement: 2, ingredient: harissa_paste, recipe: broadbean_recipe, unit: "tsp")
Quantity.create(measurement: 2, ingredient: wholegrain_mustard, recipe: broadbean_recipe, unit: "tsp")
Quantity.create(measurement: 2, ingredient: white_wine_vinegar, recipe: broadbean_recipe, unit: "tsp")
Quantity.create(measurement: 1, ingredient: egg, recipe: broadbean_recipe)
Quantity.create(measurement: 1, ingredient: sugar, recipe: broadbean_recipe, unit: "tsp")
...
Quantity.create(measurement: 100, ingredient: brown_lentils, recipe: asparagus_recipe2, unit: "g")
Quantity.create(measurement: 50, ingredient: cracked_wheat, recipe: asparagus_recipe2, unit: "g")
Quantity.create(measurement: 250, ingredient: asparagus, recipe: asparagus_recipe2, unit: "g")
Quantity.create(measurement: 6, ingredient: parsley, recipe: asparagus_recipe2, unit: "tbsp")
Quantity.create(measurement: 2, ingredient: spring_onions, recipe: asparagus_recipe2)
Quantity.create(measurement: 50, ingredient: sprouted_mung_beans, recipe: asparagus_recipe2, unit: "g")
Quantity.create(measurement: 80, ingredient: lemon_juice, recipe: asparagus_recipe2, unit: "ml")
Quantity.create(measurement: 50, ingredient: oil, recipe: asparagus_recipe2, unit: "ml")
Quantity.create(measurement: 25, ingredient: micro_herbs, recipe: asparagus_recipe2, unit: "g")
